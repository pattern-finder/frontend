...
export const ChallengeListitem = ({
  ...
  const runOnClickRemove = (bpAddName: string, bpRmName: string,  id: string) => {
          ...
          <div className="flex flex-row mt-4 text-sm">
            <div>
              ...
              <button
                ...
                onClick={() => runOnClickAdd(`bpAdd${name}`, `bpRm${name}`, `${_id}`)}
              >
                Add
              </button>
              ...
              <button
                ...
                onClick={() => runOnClickRemove(`bpAdd${name}`, `bpRm${name}`, `${_id}`)}
              >
                Remove
              </button>
              </div>

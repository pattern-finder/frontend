...
var DonutValue = function (_a) {
    ...
    return showValue ? (React__default['default'].createElement("div", { style: __assign({ alignItems: symbolPosition === 'top-right' || symbolPosition === 'top-left'
                ? ''
        ...
        React__default['default'].createElement("span", { style: style, className: "Donut__value " + className }, children),
        React__default['default'].createElement("span", { "data-testid": 'symbol', style: styleSymbol, className: 'Donut__symbol' }, symbol || '%'))) : null;
};
...
var Donut = function (_a) {
    ...
    return (React__default['default'].createElement("div", { style: { width: size, color: color }, "data-testid": 'donut', className: 'Donut' },
        React__default['default'].createElement("svg", { style: style, width: size, height: size, className: "Donut__svg " + className },
            React__default['default'].createElement("circle", { r: radius, cx: halfSize, cy: halfSize, transform: rotateVal, style: styleTrack
            ...
            React__default['default'].createElement("circle", { r: radius, cx: halfSize, cy: halfSize, transform: rotateVal, style: styleIndicator
        ...
        React__default['default'].createElement("div", { className: 'Donut__text-container' }, typeof children === 'number' ||
            typeof children === 'string' ||
            typeof children === 'undefined' ? (React__default['default'].createElement(DonutValue, { presentValue: presentValue }, children === 'undefined' ? '0' : children)) : (React.Children.map(children, function (child) {
            return React.cloneElement(child, { presentValue: presentValue });
        })))));
};
...
var DonutLabel = function (_a) {
    ...
    return (React__default['default'].createElement("h6", { style: style, className: (multiple ? 'Donut-multiple__label' : 'Donut__label') + " " + (className || '') }, children || ''));
};
...
var DonutSubtitle = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: 'Donut-multiple__subtitle' },
        React__default['default'].createElement("div", { className: 'Donut-multiple__block-color', style: { backgroundColor: color } }),
        React__default['default'].createElement("span", { className: 'Donut-multiple__subtitle-name' }, name)));
};
...
var DonutMultiple = function (_a) {
    ...
    var filled = 0;
    return (React__default['default'].createElement("div", { style: { width: size }, className: 'Donut-multiple', "data-testid": 'donut-multiple' },
        React__default['default'].createElement("svg", { className: className, strokeLinecap: linecap, width: size, viewBox: '0 0 100 100' }, React.Children.map(children, function (child) {
            if (child.type.name === donutElement) {
        ...
        React.Children.map(children, function (child) {
            if (child.type.name === donutLabel) {
                return React.cloneElement(child, { multiple: true });
            }
        }),
        React__default['default'].createElement("div", { className: 'Donut-multiple__subtitles' }, React.Children.map(children, function (child) {
            if (child.type.name === donutElement && child.props.name) {
                return React.cloneElement(React__default['default'].createElement(DonutSubtitle, { name: child.props.name, color: child.props.color || 'black' }));
            }
        }))));
};
...
var DonutElement = function (_a) {
    ...
    return (React__default['default'].createElement("circle", { "data-testid": 'donut-element', cx: 50, cy: 50, r: radius, fill: 'transparent', strokeWidth: strokeWidth, stroke: color, strokeDasharray: dashArray, strokeDashoffset: offset, transform: "rotate(" + angle + " " + cx + " " + cy + ")" }, animate ? (React__default['default'].createElement("animateTransform", { attributeName: 'transform', attributeType: 'XML', type: 'rotate', from: startAngle + " " + cx + " " + cy, to: angle + " " + cx + " " + cy, dur: '1s' })) : null));
};

exports.Donut = Donut;
exports.DonutElement = DonutElement;
exports.DonutLabel = DonutLabel;
exports.DonutMultiple = DonutMultiple;

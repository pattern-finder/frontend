...
declare class TokenObject {
     ...
     * @constructor
     */
    constructor({ authStorageName, authStorageType, authTimeStorageName, stateStorageName, refreshTokenName, cookieDomain, cookieSecure, }: TokenObjectParamsInterface);
    /**
     ...
     *
     */
    checkTokenExist(authToken: string | null | undefined, authTokenType: string | null | undefined, authTokenTime: string | null | undefined, stateCookie: string | null | undefined, refreshToken: string | null | undefined, refreshTokenTime: string | null | undefined): TokenInterface;
    /**
